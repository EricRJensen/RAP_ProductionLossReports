...
## About these Reports
Vegetation production is the most fundamental and important ecosystem service that rangelands provide, but tree encroachment is resulting in significantly diminished vegetation production in many locations. These reports build upon advances in remote sensing and vegetation modeling to provide state- and county-level estimates of the amount of rangeland production (lbs/acre) lost to tree encroachment. 

Use the interactive map below to navigate to any of the 17 states and 1,062 counties for which we have generated reports. Learn more about the science and analysis behind these reports in the [Supporting Information section](#supporting-information), below.
...
leaflet(
  ...
  addLegend(
    position = "bottomleft",
    pal = pal,
    values = sort(unmask_ctys_sf$yieldgap_2019_norm, decreasing = TRUE)[1:840],
