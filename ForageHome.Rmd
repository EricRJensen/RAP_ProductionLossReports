---
title: "Rangeland Production Lost to Woody Encroachment"
...
htmltools::HTML(
  paste(
    '<div class="container">
                          ...
                          Rangeland Production Lost to<br>Woody Encroachment
                          </div>
                       </div>',
    sep = ''
  )
...
## About these Reports
Vegetation production is the most fundamental and important ecosystem service that rangelands provide, but woody encroachment is resulting in significantly diminished vegetation production in many locations. These reports build upon advances in remote sensing and vegetation modeling to provide state- and county-level estimates of the amount of rangeland production (lbs/acre) lost to woody encroachment. 

Use the interactive map below to navigate to any of the 17 states and 1,062 counties for which we have generated reports. Learn more about the science and analysis behind these reports in the [Supplemental Information section](#supporting-information), below.
...
## Westwide Rangeland Production Lost to Woody Encroachment
```{r echo = FALSE, warning = FALSE}
main_df_rec <- main_df %>%
  filter(year == current_year)
...
rampcols <-
  colorRampPalette(
    ...
    space = "Lab",
    bias = 2
  )(max(nonFor_ctys_sf$yieldgap_2019_norm, na.rm = TRUE) * 1000)

pal <-
  colorNumeric(rampcols, domain = c(0, max(
    nonFor_ctys_sf$yieldgap_2019_norm, na.rm = TRUE
  )), na.color = '#ffffff')
...
leaflet(
  ...
  addLegend(
    position = "bottomleft",
    pal = pal,
    values = sort(nonFor_ctys_sf$yieldgap_2019_norm, decreasing = TRUE)[1:840],
...
*The plots below depict herbaceous production losses resulting from tree cover change on an annually (left) and cumulatively (right) for the period of 1990-`r as.character(current_year)`. The annual plot displays the same information as the map above. In instances where tree cover has declined, rangeland production may increase.*
    ...
    <div class="panel-heading" role="tab" id="headingOne">
      <h4 class="panel-title">
        <a class="collapsed" role="button" data-toggle="collapse" data-parent="#accordion" href="#collapseOne" aria-expanded="false" aria-controls="collapseOne">
          Calculating Rangeland Rangeland Production Losses to Woody Encroachment
        </a>
      </h4>
    </div>
